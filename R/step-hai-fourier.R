...
#'
#' @description
#' `step_hai_fourier` creates a a *specification* of a recipe
...
#'
#' @return For `step_hai_fourier`, an updated version of recipe with
...
#'  Unlike other steps, `step_hai_fourier` does *not*
